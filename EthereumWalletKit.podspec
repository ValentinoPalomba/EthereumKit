...
Pod::Spec.new do |spec|
 ...
 spec.homepage = "https://github.com/ValentinoPalomba/EthereumKit"
  ...
  spec.author             = { "Valentino Palomba" => "valentinopalomba2@gmail.com" }
  # Or just: spec.author    = "Valentino Palomba"
  # spec.authors            = { "Valentino Palomba" => "valentinopalomba2@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Valentino Palomba"
  ...
  spec.source_files  = 'EthereumKit/Sources/**/*.{swift,h,m}'
